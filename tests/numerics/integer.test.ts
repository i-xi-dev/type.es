...
Deno.test("Integer.isPositive()", () => {
  assertStrictEquals(Integer.isPositive(0), false);
  assertStrictEquals(Integer.isPositive(-0), false);
  assertStrictEquals(Integer.isPositive(1), true);
  assertStrictEquals(Integer.isPositive(-1), false);

  assertStrictEquals(Integer.isPositive(-10.1), false);
  assertStrictEquals(Integer.isPositive(-9.9), false);
  assertStrictEquals(Integer.isPositive(9.9), false);
  assertStrictEquals(Integer.isPositive(10.1), false);

  assertStrictEquals(Integer.isPositive(0n), false);
  assertStrictEquals(Integer.isPositive(-0n), false);
  assertStrictEquals(Integer.isPositive(1n), true);
  assertStrictEquals(Integer.isPositive(-1n), false);

  assertStrictEquals(Integer.isPositive(Number.NaN), false);
  assertStrictEquals(Integer.isPositive(Number.POSITIVE_INFINITY), false);
  assertStrictEquals(
    Integer.isPositive(Number.MAX_SAFE_INTEGER + 1),
    false,
  );
  assertStrictEquals(Integer.isPositive(Number.MAX_SAFE_INTEGER), true);
  assertStrictEquals(Integer.isPositive(Number.MIN_SAFE_INTEGER), false);
  assertStrictEquals(
    Integer.isPositive(Number.MIN_SAFE_INTEGER - 1),
    false,
  );
  assertStrictEquals(Integer.isPositive(Number.NEGATIVE_INFINITY), false);

  assertStrictEquals(
    Integer.isPositive(BigInt(Number.MAX_SAFE_INTEGER) + 1n),
    true,
  );
  assertStrictEquals(
    Integer.isPositive(BigInt(Number.MAX_SAFE_INTEGER)),
    true,
  );
  assertStrictEquals(
    Integer.isPositive(BigInt(Number.MIN_SAFE_INTEGER)),
    false,
  );
  assertStrictEquals(
    Integer.isPositive(BigInt(Number.MIN_SAFE_INTEGER) - 1n),
    false,
  );

  assertStrictEquals(
    Integer.isPositive(undefined as unknown as number),
    false,
  );
  assertStrictEquals(Integer.isPositive(null as unknown as number), false);
  assertStrictEquals(Integer.isPositive(true as unknown as number), false);
  assertStrictEquals(Integer.isPositive(false as unknown as number), false);
  assertStrictEquals(Integer.isPositive("" as unknown as number), false);
  assertStrictEquals(Integer.isPositive("0" as unknown as number), false);
});

Deno.test("Integer.isNonNegative()", () => {
  assertStrictEquals(Integer.isNonNegative(0), true);
  assertStrictEquals(Integer.isNonNegative(-0), true);
  assertStrictEquals(Integer.isNonNegative(1), true);
  assertStrictEquals(Integer.isNonNegative(-1), false);

  assertStrictEquals(Integer.isNonNegative(-10.1), false);
  assertStrictEquals(Integer.isNonNegative(-9.9), false);
  assertStrictEquals(Integer.isNonNegative(9.9), false);
  assertStrictEquals(Integer.isNonNegative(10.1), false);

  assertStrictEquals(Integer.isNonNegative(0n), true);
  assertStrictEquals(Integer.isNonNegative(-0n), true);
  assertStrictEquals(Integer.isNonNegative(1n), true);
  assertStrictEquals(Integer.isNonNegative(-1n), false);

  assertStrictEquals(Integer.isNonNegative(Number.NaN), false);
  assertStrictEquals(
    Integer.isNonNegative(Number.POSITIVE_INFINITY),
    false,
  );
  assertStrictEquals(
    Integer.isNonNegative(Number.MAX_SAFE_INTEGER + 1),
    false,
  );
  assertStrictEquals(Integer.isNonNegative(Number.MAX_SAFE_INTEGER), true);
  assertStrictEquals(Integer.isNonNegative(Number.MIN_SAFE_INTEGER), false);
  assertStrictEquals(
    Integer.isNonNegative(Number.MIN_SAFE_INTEGER - 1),
    false,
  );
  assertStrictEquals(
    Integer.isNonNegative(Number.NEGATIVE_INFINITY),
    false,
  );

  assertStrictEquals(
    Integer.isNonNegative(BigInt(Number.MAX_SAFE_INTEGER) + 1n),
    true,
  );
  assertStrictEquals(
    Integer.isNonNegative(BigInt(Number.MAX_SAFE_INTEGER)),
    true,
  );
  assertStrictEquals(
    Integer.isNonNegative(BigInt(Number.MIN_SAFE_INTEGER)),
    false,
  );
  assertStrictEquals(
    Integer.isNonNegative(BigInt(Number.MIN_SAFE_INTEGER) - 1n),
    false,
  );

  assertStrictEquals(
    Integer.isNonNegative(undefined as unknown as number),
    false,
  );
  assertStrictEquals(
    Integer.isNonNegative(null as unknown as number),
    false,
  );
  assertStrictEquals(
    Integer.isNonNegative(true as unknown as number),
    false,
  );
  assertStrictEquals(
    Integer.isNonNegative(false as unknown as number),
    false,
  );
  assertStrictEquals(Integer.isNonNegative("" as unknown as number), false);
  assertStrictEquals(
    Integer.isNonNegative("0" as unknown as number),
    false,
  );
});

Deno.test("Integer.isNonPositive()", () => {
  assertStrictEquals(Integer.isNonPositive(0), true);
  assertStrictEquals(Integer.isNonPositive(-0), true);
  assertStrictEquals(Integer.isNonPositive(1), false);
  assertStrictEquals(Integer.isNonPositive(-1), true);

  assertStrictEquals(Integer.isNonPositive(-10.1), false);
  assertStrictEquals(Integer.isNonPositive(-9.9), false);
  assertStrictEquals(Integer.isNonPositive(9.9), false);
  assertStrictEquals(Integer.isNonPositive(10.1), false);

  assertStrictEquals(Integer.isNonPositive(0n), true);
  assertStrictEquals(Integer.isNonPositive(-0n), true);
  assertStrictEquals(Integer.isNonPositive(1n), false);
  assertStrictEquals(Integer.isNonPositive(-1n), true);

  assertStrictEquals(Integer.isNonPositive(Number.NaN), false);
  assertStrictEquals(
    Integer.isNonPositive(Number.POSITIVE_INFINITY),
    false,
  );
  assertStrictEquals(
    Integer.isNonPositive(Number.MAX_SAFE_INTEGER + 1),
    false,
  );
  assertStrictEquals(Integer.isNonPositive(Number.MAX_SAFE_INTEGER), false);
  assertStrictEquals(Integer.isNonPositive(Number.MIN_SAFE_INTEGER), true);
  assertStrictEquals(
    Integer.isNonPositive(Number.MIN_SAFE_INTEGER - 1),
    false,
  );
  assertStrictEquals(
    Integer.isNonPositive(Number.NEGATIVE_INFINITY),
    false,
  );

  assertStrictEquals(
    Integer.isNonPositive(BigInt(Number.MAX_SAFE_INTEGER) + 1n),
    false,
  );
  assertStrictEquals(
    Integer.isNonPositive(BigInt(Number.MAX_SAFE_INTEGER)),
    false,
  );
  assertStrictEquals(
    Integer.isNonPositive(BigInt(Number.MIN_SAFE_INTEGER)),
    true,
  );
  assertStrictEquals(
    Integer.isNonPositive(BigInt(Number.MIN_SAFE_INTEGER) - 1n),
    true,
  );

  assertStrictEquals(
    Integer.isNonPositive(undefined as unknown as number),
    false,
  );
  assertStrictEquals(
    Integer.isNonPositive(null as unknown as number),
    false,
  );
  assertStrictEquals(
    Integer.isNonPositive(true as unknown as number),
    false,
  );
  assertStrictEquals(
    Integer.isNonPositive(false as unknown as number),
    false,
  );
  assertStrictEquals(Integer.isNonPositive("" as unknown as number), false);
  assertStrictEquals(
    Integer.isNonPositive("0" as unknown as number),
    false,
  );
});
