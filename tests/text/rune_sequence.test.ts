...
Deno.test("RuneSequence.isBelongToScripts()", () => {
  const k = ["Kana"];
  const h = ["Hira"];
  const l = ["Latn"];
  const lc = ["Latn", "Zyyy"];
  ...
  assertStrictEquals(RuneSequence.isBelongToScripts("ア", k), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("ア", h), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("ア", k, opEx), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("ア", h, opEx), false);

  assertStrictEquals(RuneSequence.isBelongToScripts("あ", k), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("あ", h), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("あ", k, opEx), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("あ", h, opEx), true);

  assertStrictEquals(RuneSequence.isBelongToScripts("ー", k), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("ー", h), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("ー", k, opEx), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("ー", h, opEx), false);

  assertStrictEquals(RuneSequence.isBelongToScripts("か\u3099", k), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("か\u3099", h), true);
  assertStrictEquals(
    RuneSequence.isBelongToScripts("か\u3099", k, opEx),
    false,
  );
  assertStrictEquals(
    RuneSequence.isBelongToScripts("か\u3099", h, opEx),
    false,
  );

  assertStrictEquals(RuneSequence.isBelongToScripts("カ\u3099", k), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("カ\u3099", h), false);
  assertStrictEquals(
    RuneSequence.isBelongToScripts("カ\u3099", k, opEx),
    false,
  );
  assertStrictEquals(
    RuneSequence.isBelongToScripts("カ\u3099", h, opEx),
    false,
  );

  assertStrictEquals(RuneSequence.isBelongToScripts("", l), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("a", l), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("aa", l), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("1aa", l), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("a1a", l), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("aa1", l), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("aaa", l), true);

  assertStrictEquals(RuneSequence.isBelongToScripts("", l, opEx), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("a", l, opEx), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("aa", l, opEx), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("1aa", l, opEx), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("a1a", l, opEx), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("aa1", l, opEx), false);
  assertStrictEquals(RuneSequence.isBelongToScripts("aaa", l, opEx), true);

  assertStrictEquals(RuneSequence.isBelongToScripts("", lc, opEx), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("a", lc, opEx), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("aa", lc, opEx), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("1aa", lc, opEx), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("a1a", lc, opEx), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("aa1", lc, opEx), true);
  assertStrictEquals(RuneSequence.isBelongToScripts("aaa", lc, opEx), true);

  assertStrictEquals(RuneSequence.isBelongToScripts(null, l), false);

  assertThrows(
    () => {
      RuneSequence.isBelongToScripts("a", ["Aaaaa"]);
    },
    TypeError,
