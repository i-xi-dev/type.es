...
Deno.test("Uri.prototype.path", () => {
  ...
  assertStrictEquals(str(u0.path.segment()), '[""]');
  ...
  assertStrictEquals(str(u0b.path.segment()), '[""]');
  ...
  assertStrictEquals(str(u1.path.segment()), '["hoge"]');
  ...
  assertStrictEquals(str(u2.path.segment()), '["hog/e"]');
  ...
  assertStrictEquals(str(u3.path.segment()), '["D:","hoge","index.txt"]');
  ...
  assertStrictEquals(str(u6.path.segment()), "[]");
  ...
  assertStrictEquals(str(p7.segment()), '[""]');
