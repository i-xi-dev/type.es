...
Deno.test("Events.EventFactory.createProgressEvent()", () => {
  const event1 = EventFactory.create<ProgressEvent>(
    EventType.PROGRESS,
    "progress-x",
  );
  ...
  const event2 = EventFactory.create<ProgressEvent>(
    EventType.PROGRESS,
    "progress-x",
    {},
  );
...
Deno.test("Events.EventFactory.createProgressEvent() - lengthComputable", () => {
  const event3 = EventFactory.create<ProgressEvent>(
    EventType.PROGRESS,
    "progress-x",
    {
...
Deno.test("Events.EventFactory.createProgressEvent() - loaded", () => {
  const event4 = EventFactory.create<ProgressEvent>(
    EventType.PROGRESS,
    "progress-x",
    {
      loaded: 11,
...
Deno.test("Events.EventFactory.createProgressEvent() - total", () => {
  const event5 = EventFactory.create<ProgressEvent>(
    EventType.PROGRESS,
    "progress-x",
    {
      total: 22,
