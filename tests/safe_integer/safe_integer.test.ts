...
Deno.test("SafeInteger.clampToRange()", () => {
  const e1 = "`value` must be a safe integer.";
  assertThrows(
    () => {
      SafeInteger.clampToRange(undefined as unknown as number, [0, 0]);
    },
    TypeError,
    e1,
  );
  ...
  assertThrows(
    () => {
      SafeInteger.clampToRange(0, [undefined as unknown as number, 0]);
    },
    TypeError,
    e2,
  );
  ...
  assertThrows(
    () => {
      SafeInteger.clampToRange(0, [0, undefined as unknown as number]);
    },
    TypeError,
    e3,
  );
  ...
  assertThrows(
    () => {
      SafeInteger.clampToRange(0, [1, 0]);
    },
    RangeError,
    e4,
  );

  assertStrictEquals(SafeInteger.clampToRange(-2, [-1, 0]), -1);
  assertStrictEquals(SafeInteger.clampToRange(-1, [-1, 0]), -1);
  assertStrictEquals(SafeInteger.clampToRange(0, [-1, 0]), 0);
  assertStrictEquals(SafeInteger.clampToRange(1, [-1, 0]), 0);

  assertStrictEquals(SafeInteger.clampToRange(-1, [0, 0]), 0);
  assertStrictEquals(SafeInteger.clampToRange(0, [0, 0]), 0);
  assertStrictEquals(SafeInteger.clampToRange(1, [0, 0]), 0);

  assertStrictEquals(SafeInteger.clampToRange(-1, [0, 1]), 0);
  assertStrictEquals(SafeInteger.clampToRange(0, [0, 1]), 0);
  assertStrictEquals(SafeInteger.clampToRange(1, [0, 1]), 1);
  assertStrictEquals(SafeInteger.clampToRange(2, [0, 1]), 1);

  assertStrictEquals(SafeInteger.clampToRange(-1, [0, 2]), 0);
  assertStrictEquals(SafeInteger.clampToRange(0, [0, 2]), 0);
  assertStrictEquals(SafeInteger.clampToRange(1, [0, 2]), 1);
  assertStrictEquals(SafeInteger.clampToRange(2, [0, 2]), 2);
  assertStrictEquals(SafeInteger.clampToRange(3, [0, 2]), 2);
});
