...
Deno.test("Buffers.ArrayBuffer.fromUint8Iterable(Array<uint8>)", () => {
  assertThrows(
    () => {
...
Deno.test("Buffers.ArrayBuffer.fromUint8Iterable(Uint8Array)", () => {
  assertStrictEquals(
...
Deno.test("Buffers.ArrayBuffer.fromUint8Iterable(Generator<uint8>)", () => {
  const g0 = (function* () {
  })();
